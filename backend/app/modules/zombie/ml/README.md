...
- **混同行列**: `backend/app/modules/zombie/ml/confusion_matrix.png`
- **学習履歴**: `backend/app/modules/zombie/ml/training_history.png`
...
```bash
python backend/app/modules/zombie/ml/infer_zombie_classifier.py [画像パス]
```
